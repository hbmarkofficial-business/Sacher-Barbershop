  ...
  return (
    <>
      <Helmet>
        ...
        <title>Barbershop Berlin | Sacher Barbershop</title>
        <meta
          name="description"
          content="Besuche unseren Premium Barbershop Sacher Barbershop in Berlin für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Sacher Barbershop | Premium Barbershop Berlin" />
        <meta
        ...
        <meta name="twitter:title" content="Sacher Barbershop | Premium Barbershop Berlin" />
        <meta
